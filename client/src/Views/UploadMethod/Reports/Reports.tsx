			...
			<div className={styles["reports-content"]}>
				<div className={styles["header"]}>
					<div className={styles["header-text"]}>
						...
						<p className={styles["subtitle"]}>
							AI-synthesized clinical summaries locally encrypted in your secure health vault.
						</p>
					</div>
						...
						<div className={styles["provenance-item"]}>
							...
							<div className={styles["item-info"]}>
								...
								<p className={styles["item-detail"]}>
									All reports are signed by Genetiq Lab and protected inside local secure enclave.
								</p>
							</div>
				...
				<footer className={styles["report-footer"]}>
					...
					<div className={styles["vault-info"]}>
						<span>Protocol: Secure Enclave</span>
						<span>•</span>
						<span>Status: Biometric Enclave Vault</span>
					</div>
				</footer>
			</div>
		</div>
