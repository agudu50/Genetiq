				...
				reasons: [
					{
						...
						status: "High",
						description:
							"Apolipoprotein B measures the total number of atherogenic particles in the bloodstream. Your level of 128 mg/dL is elevated above optimal targets (reference range: < 90 mg/dL).",
						date: "<90",
					},
					{
						id: 2,
						...
						icon: Drop,
						test: "Lipid Panel",
						level: { type: "progress", src: 70 },
						value: "142",
						unit: "mg/dL",
						statusText: "Above optimal",
						status: "High",
						description:
							'LDL is often called "bad cholesterol" because high levels can slowly build up in arterial walls. Your level of 142 mg/dL is elevated above standard targets (reference range: < 100 mg/dL).',
						date: "<100",
					},
					{
						id: 3,
						...
						icon: Drop,
						test: "Inflammation",
						level: { type: "progress", src: 68 },
						value: "3.4",
						unit: "mg/L",
						statusText: "Above optimal",
						status: "High",
						description:
							"High-sensitivity C-reactive protein indicates persistent vascular endothelial inflammation (reference range: < 1.0 mg/L).",
						date: "<1.0",
					},
					{
						id: 4,
						...
						icon: Drop,
						test: "Renal Panel",
						level: { type: "progress", src: 40 },
						value: "78",
						unit: "mL/min",
						statusText: "Mildly reduced",
						status: "Low",
						description:
							"eGFR measures glomerular filtration efficiency. Your level of 78 mL/min reflects mild filtration strain (reference range: > 90 mL/min).",
						date: ">90",
					},
					{
						id: 5,
						...
						status: "High",
						description:
							"Fasting blood glucose measures baseline blood sugar levels. Your level of 104 mg/dL indicates borderline elevation (reference range: 70 - 99 mg/dL).",
						date: "70-99",
					},
				],
				symptoms: {
