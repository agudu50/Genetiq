...
const OFFLINE_TRANSLATIONS: Record<string, Record<string, string>> = {
	twi: {
		...
		"All Results": "Nhwehwɛmu Nyinaa",
		"Need Attention": "Hia Nhwehwɛmu",
		"Needs Attention": "Hia Nhwehwɛmu",
		"What this score range means": "Deɛ saa ahoɔden bɔ yi kyerɛ",
		"Optimal": "Ɛyɛ papa koraa",
		"Low": "Ɛba fam",
		"High": "Ɛkɔ soro",
		"Negative": "Enni mu",
		"Positive": "Ɛwɔ mu",
		"Non-reactive": "Enni mu (Non-reactive)",
		"Reactive": "Ɛwɔ mu (Reactive)",
		"Action needed": "Hia ayaresa ntɛm",
		"1 or more markers outside reference range": "Nhwehwɛmu 1 anaa pii mfa deɛ ɛtaa yɛ mu",
		"Minor variations from baseline": "Nsonsonoeɛ kakra bi wɔ mu",
		"Mostly within healthy limits": "Dodoɔ no ara yɛ papa wɔ ahoɔden mu",
		"All markers in standard optimal range": "Nhwehwɛmu nyinaa yɛ papa koraa",
		"Some test markers fall outside standard reference ranges.": "Nhwehwɛmu bi mfa deɛ ɛtaa yɛ mu.",
		"Most values are stable, but a few markers show minor variations.": "Nhwehwɛmu dodoɔ no ara yɛ papa, nanso kakra bi sesae.",
		"Your lab results fall mostly within standard healthy reference ranges.": "Wo lab nhwehwɛmu dodoɔ no ara wɔ ahoɔden pa mu.",
		"All extracted lab values fall cleanly within expected healthy reference ranges.": "Wo lab nhwehwɛmu nyinaa yɛ papa koraa.",
		"A score in the 0–50 range means 1 or more lab markers are outside normal limits. This is a prompt for a routine medical review—not a cause for panic. Everyday factors like hydration, minor infections, or sample timing can affect lab numbers.": "Ahoɔden bɔ 0–50 kyerɛ sɛ nhwehwɛmu baako anaa pii mfa deɛ ɛtaa yɛ mu. Yei kyerɛ sɛ wokɔ dɔkota nkyɛn — mma w'adwene nsiw. Nsuo a worenom, ɔyare mmoawa, anaa berɛ betumi asesa akontaahyɛdeɛ.",
		"A score in the 51–74 range indicates mostly steady health with a couple of values to monitor over time.": "Ahoɔden bɔ 51–74 kyerɛ sɛ wo ho yɛ kyɛn kan, nanso nsɛm kakra bi wɔ hɔ a ɛsɛ sɛ wohwɛ daa.",
		"A score in the 75–89 range reflects healthy baseline values. Maintain your routine wellness habits.": "Ahoɔden bɔ 75–89 kyerɛ sɛ wo ho yɛ koraa. Kɔ so yɛ akwahosan nneyɛeɛ pa.",
		"A score in the 90–100 range means all analyzed test markers are within standard optimal limits.": "Ahoɔden bɔ 90–100 kyerɛ sɛ wo nhwehwɛmu nyinaa yɛ papa koraa wɔ deɛ ɛsɛ mu.",
		"Boost Blood Health": "Ma Mogya Ahoɔden So",
		"Support Immunity": "Boa Banbɔ Dwumadie",
		"Stay Hydrated": "Nom Nsuo Pii Daa",
		"Consult a Pediatrician": "Kasa Kyerɛ Dɔkota Pa",
		"Consult a Doctor": "Kasa Kyerɛ Dɔkota Pa",
		"Since the PCV (red blood cell volume) is slightly low, encourage the child to eat more Kontomire (cocoyam leaves) and Moringa powder. These are rich in iron which helps build healthy blood. Pair these with a little bit of orange juice to help the body absorb the iron better.": "Esiane sɛ PCV (mogya dodoɔ) aba fam kakra nti, hyɛ nkuran ma wonni kontomire ne moringa powder pii. Yeinom wɔ dada (iron) pii a ɛboa ma mogya yɛ den. Fa ankaa nsuo kakra fra mu ma wo honam ntumi nnonsu iron no yiye.",
		"The WBC (white blood cell count) is a bit low, meaning the immune system needs support. Provide nutritious, easy-to-digest meals like light Koko (porridge) and plenty of fresh fruits like oranges or mangoes to provide vitamins that help the body fight germs.": "WBC (mmoawa kofoɔ dodoɔ) aba fam kakra, a ɛkyerɛ sɛ banbɔ ho hia mmoa. Ma aduane pa a ɛyɛ mmerɛw sɛ wɔbɛwe te sɛ koko mmerɛw ne nsuaba frɔmfrɔm te sɛ ankaa anaa mangoes na emua vitamins a ɛko yareɛ mmoawa.",
		"Ensure the child drinks plenty of clean, boiled water or coconut water throughout the day to keep their body systems running smoothly and help with overall recovery.": "Hwɛ sɛ wɔnom nsuo fiideɛ a wɔanono anaa kubesuo pii da mu nyinaa na ama honam mu adwumadie akɔ so yiye na wanya ahoɔden.",
		"Because the white blood cell count and basophils are slightly out of the normal range, please take these results to your local doctor or pediatrician. They can check if this is due to a recent mild infection or an allergy.": "Esiane sɛ white blood cell count ne basophils mfa deɛ ɛtaa yɛ mu nti, yɛsrɛ wo fa saa nhwehwɛmu yi kɔ wo dɔkota nkyɛn. Wɔbɛtumi ahwɛ sɛ ebia ɛfiri ɔyare mmoawa kakra anaa allergy.",
		"Always speak to a qualified doctor or pediatrician about your health. Visit your nearest CHPS compound or health center for clinical evaluation.": "Kasa kyerɛ dɔkota pa biara ɛfa wo ahoɔden ho daa. Kɔ CHPS compound anaa ayaresabea a ɛbɛn wo nkyɛn na wɔnhwɛ wo yiye."
	},
	ga: {
		...
		"All Results": "Results Fɛɛ",
		"Need Attention": "Hia Yelikɛlɔ",
		"Needs Attention": "Hia Yelikɛlɔ",
		"What this score range means": "Nɔ ni score nɛɛ tsɔɔ",
		"Optimal": "Ehi kpakpa",
		"Low": "Eba shi",
		"High": "Eyi kɛ nɔ",
		"Negative": "Bɛɛ mli",
		"Positive": "Yɛ mli",
		"Non-reactive": "Bɛɛ mli (Non-reactive)",
		"Reactive": "Yɛ mli (Reactive)",
		"Action needed": "Hia yelikɛlɔ ntɛm",
		"1 or more markers outside reference range": "Result 1 loo pii eyeee tamɔ bɔ ni efɔɔ mli",
		"Minor variations from baseline": "Nsonsonoeɛ fioo yɛ mli",
		"Mostly within healthy limits": "Pii lɛ eyeɔ jogbaŋŋ yɛ hewalɛ mli",
		"All markers in standard optimal range": "Results fɛɛ eyeɔ kpakpa",
		"Some test markers fall outside standard reference ranges.": "Results komɛi eyeee tamɔ bɔ ni efɔɔ mli.",
		"Most values are stable, but a few markers show minor variations.": "Results pii eyeɔ jogbaŋŋ, shi fioo komɛi tsake.",
		"Your lab results fall mostly within standard healthy reference ranges.": "O lab results fɛɛ eyeɔ jogbaŋŋ yɛ hewalɛ mli.",
		"All extracted lab values fall cleanly within expected healthy reference ranges.": "O lab results fɛɛ eyeɔ kpakpa yɛ hewalɛ mli.",
		"A score in the 0–50 range means 1 or more lab markers are outside normal limits. This is a prompt for a routine medical review—not a cause for panic. Everyday factors like hydration, minor infections, or sample timing can affect lab numbers.": "Score 0–50 tsɔɔ akɛ result 1 loo pii eyeee tamɔ bɔ ni efɔɔ mli. Enɛ hiaa akɛ yaa dɔkita he.",
		"A score in the 51–74 range indicates mostly steady health with a couple of values to monitor over time.": "Score 51–74 tsɔɔ akɛ hewalɛ lɛ eyeɔ jogbaŋŋ, shi kwɛ nii fioo komɛi.",
		"A score in the 75–89 range reflects healthy baseline values. Maintain your routine wellness habits.": "Score 75–89 tsɔɔ akɛ o hewalɛ eyeɔ jogbaŋŋ. Yaa nɔ nakai.",
		"A score in the 90–100 range means all analyzed test markers are within standard optimal limits.": "Score 90–100 tsɔɔ akɛ o lab results fɛɛ eyeɔ kpakpa.",
		"Boost Blood Health": "Woa La Hewalɛ Nɔ",
		"Support Immunity": "Fĩ Hewalɛ He",
		"Stay Hydrated": "Nu Nu Pii Daa",
		"Consult a Pediatrician": "Wiemɔ Kɛ Dɔkita",
		"Consult a Doctor": "Wiemɔ Kɛ Dɔkita",
		"Since the PCV (red blood cell volume) is slightly low, encourage the child to eat more Kontomire (cocoyam leaves) and Moringa powder. These are rich in iron which helps build healthy blood. Pair these with a little bit of orange juice to help the body absorb the iron better.": "Kɛji PCV ba shi fioo lɛ, ye kontomire kɛ moringa pii. Enɛmɛi yɛ iron pii ni haa la eyeɔ jogbaŋŋ. Nu ankaa nu fioo kɛha iron yelikɛlɔ.",
		"The WBC (white blood cell count) is a bit low, meaning the immune system needs support. Provide nutritious, easy-to-digest meals like light Koko (porridge) and plenty of fresh fruits like oranges or mangoes to provide vitamins that help the body fight germs.": "WBC ba shi fioo, ni tsɔɔ akɛ hewalɛ banbɔ hiaa yelikɛlɔ. Ye koko mlɛo kɛ yibii tamɔ ankaa loo mangoes ni yɔɔ vitamins kɛha mmoawa tuomɔ.",
		"Ensure the child drinks plenty of clean, boiled water or coconut water throughout the day to keep their body systems running smoothly and help with overall recovery.": "Kwɛ akɛ eenu nu pii ni tse loo kubesuo yɛ gbi lɛ mli fɛɛ koni hewalɛ yaa nɔ jogbaŋŋ.",
		"Because the white blood cell count and basophils are slightly out of the normal range, please take these results to your local doctor or pediatrician. They can check if this is due to a recent mild infection or an allergy.": "Kɛji white blood cell count kɛ basophils eyeee tamɔ bɔ ni efɔɔ mli lɛ, kɛ nɛɛ yaa o dɔkita he koni ekwɛ kɛji eji hela fioo loo allergy.",
		"Always speak to a qualified doctor or pediatrician about your health. Visit your nearest CHPS compound or health center for clinical evaluation.": "Wiemɔ kɛ datrɛfonyo kpakpa yɛ wo hewale he daa. Yaa CHPS compound loo tsɔfabuu ni bɛŋkɛ bo."
	},
	ewe: {
		...
		"All Results": "Ŋkuɖoɖo Katã",
		"Need Attention": "Hiã Lãmesẽ",
		"Needs Attention": "Hiã Lãmesẽ",
		"What this score range means": "Nusi xexlẽme sia fia",
		"Optimal": "Enyo ŋutɔ",
		"Low": "Ege ɖe anyi",
		"High": "Kɔkɔ wu",
		"Negative": "Mele eme o",
		"Positive": "Ele eme",
		"Non-reactive": "Mele eme o (Non-reactive)",
		"Reactive": "Ele eme (Reactive)",
		"Action needed": "Hiã kpedekpe",
		"1 or more markers outside reference range": "Dodokpɔ 1 alo geɖe mele abe ale si wònɔna ene o",
		"Minor variations from baseline": "Tɔtrɔ ʋee aɖewo le eme",
		"Mostly within healthy limits": "Geɖe le lãmesẽ nyui me",
		"All markers in standard optimal range": "Dodokpɔwo katã le nyuie",
		"Some test markers fall outside standard reference ranges.": "Ŋkuɖoɖo aɖewo mele abe ale si wònɔna ene o.",
		"Most values are stable, but a few markers show minor variations.": "Ŋkuɖoɖo geɖe le nyuie, gake ʋee aɖewo trɔ.",
		"Your lab results fall mostly within standard healthy reference ranges.": "Wò lab ŋkuɖoɖo geɖe le lãmesẽ nyui me.",
		"All extracted lab values fall cleanly within expected healthy reference ranges.": "Wò lab ŋkuɖoɖo katã le nyuie ŋutɔ.",
		"A score in the 0–50 range means 1 or more lab markers are outside normal limits. This is a prompt for a routine medical review—not a cause for panic. Everyday factors like hydration, minor infections, or sample timing can affect lab numbers.": "Xexlẽme 0–50 fia be dodokpɔ 1 alo geɖe mele nyuie o. Esia fia be nài dɔnɔkɔdola gbɔ.",
		"A score in the 51–74 range indicates mostly steady health with a couple of values to monitor over time.": "Xexlẽme 51–74 fia be lãmesẽ le nyuie, gake kpɔ nu ʋee aɖewo ɖa.",
		"A score in the 75–89 range reflects healthy baseline values. Maintain your routine wellness habits.": "Xexlẽme 75–89 fia be wò lãmesẽ le nyuie. Yi edzi nenema.",
		"A score in the 90–100 range means all analyzed test markers are within standard optimal limits.": "Xexlẽme 90–100 fia be wò lab ŋkuɖoɖo katã le nyuie ŋutɔ.",
		"Boost Blood Health": "Do Ʋu Ƒe Lãmesẽ Ɖe Dzi",
		"Support Immunity": "Kpe Ɖe Lãmesẽ Ŋu",
		"Stay Hydrated": "No Tsi Geɖe Daa",
		"Consult a Pediatrician": "Ƒo Nu Kple Dɔnɔkɔdola",
		"Consult a Doctor": "Ƒo Nu Kple Dɔnɔkɔdola",
		"Since the PCV (red blood cell volume) is slightly low, encourage the child to eat more Kontomire (cocoyam leaves) and Moringa powder. These are rich in iron which helps build healthy blood. Pair these with a little bit of orange juice to help the body absorb the iron better.": "Abe si PCV ge ɖe anyi viɖe ene la, ɖu kontomire kple moringa geɖe. Esiawo me iron geɖe le si kpena ɖe ʋu ŋu. No aŋɔti tsi viɖe kpee be wòakpe ɖe iron la xɔxɔ ŋu.",
		"The WBC (white blood cell count) is a bit low, meaning the immune system needs support. Provide nutritious, easy-to-digest meals like light Koko (porridge) and plenty of fresh fruits like oranges or mangoes to provide vitamins that help the body fight germs.": "WBC ge ɖe anyi viɖe, esia fia be lãmesẽ hiã kpekpeɖeŋu. Ɖu koko bɔbɔe kple atito tsiagbeabewo abe aŋɔti alo maŋgoti ene be nàxɔ vitamins siwo avawɔ aʋa kple dɔlévuiwo.",
		"Ensure the child drinks plenty of clean, boiled water or coconut water throughout the day to keep their body systems running smoothly and help with overall recovery.": "Kpɔ egbɔ be nàno tsi dzadzɛ alo kpe tsi geɖe le ŋkeke la me katã be wò lãmesẽ nadɔ nyuie.",
		"Because the white blood cell count and basophils are slightly out of the normal range, please take these results to your local doctor or pediatrician. They can check if this is due to a recent mild infection or an allergy.": "Abe si white blood cell count kple basophils mele abe ale si wònɔna ene o la, tsɔ ŋkuɖoɖo siawo yi wò dɔnɔkɔdola gbɔ be wòakpɔ ne menye dɔléle viɖe alo allergy o.",
		"Always speak to a qualified doctor or pediatrician about your health. Visit your nearest CHPS compound or health center for clinical evaluation.": "Ƒo nu kple dɔnɔkɔdola daa tso lãmesẽ wò ŋu. Yi CHPS compound alo kɔdzi si te ɖe ŋuwò."
	},
	fante: {
		...
		"All Results": "Nhwehwɛmu Nyina",
		"Need Attention": "Hia Nhwehwɛmu",
		"Needs Attention": "Hia Nhwehwɛmu",
		"What this score range means": "Deɛ saa ahoɔden bɔ yi kyerɛ",
		"Optimal": "Ɔyɛ papa koraa",
		"Low": "Ɔba fam",
		"High": "Ɔkorɔn",
		"Negative": "Nni mu",
		"Positive": "Wɔ mu",
		"Non-reactive": "Nni mu (Non-reactive)",
		"Reactive": "Wɔ mu (Reactive)",
		"Action needed": "Hia ayaresa ntɛm",
		"1 or more markers outside reference range": "Nhwehwɛmu 1 anaa pii mfa dɛ ɔtaa yɛ mu",
		"Minor variations from baseline": "Nsonsonoe kakra bi wɔ mu",
		"Mostly within healthy limits": "Dodow no ara yɛ papa wɔ ahoɔden mu",
		"All markers in standard optimal range": "Nhwehwɛmu nyina yɛ papa koraa",
		"Some test markers fall outside standard reference ranges.": "Nhwehwɛmu bi nnyɛ dɛ ɔtaa yɛ mu.",
		"Most values are stable, but a few markers show minor variations.": "Nhwehwɛmu dodow no ara yɛ papa, nanso kakra bi sesae.",
		"Your lab results fall mostly within standard healthy reference ranges.": "Wo lab nhwehwɛmu dodow no ara wɔ ahoɔden pa mu.",
		"All extracted lab values fall cleanly within expected healthy reference ranges.": "Wo lab nhwehwɛmu nyina yɛ papa koraa.",
		"A score in the 0–50 range means 1 or more lab markers are outside normal limits. This is a prompt for a routine medical review—not a cause for panic. Everyday factors like hydration, minor infections, or sample timing can affect lab numbers.": "Ahoɔden bɔ 0–50 kyerɛ dɛ nhwehwɛmu kor anaa pii mfa dɛ ɔtaa yɛ mu. Yei kyerɛ dɛ wokɔ datser nkyɛn.",
		"A score in the 51–74 range indicates mostly steady health with a couple of values to monitor over time.": "Ahoɔden bɔ 51–74 kyerɛ dɛ wo ho yɛ sen kan, nanso nsɛm kakra bi wɔ hɔ a ɛsɛ dɛ wohwɛ daa.",
		"A score in the 75–89 range reflects healthy baseline values. Maintain your routine wellness habits.": "Ahoɔden bɔ 75–89 kyerɛ dɛ wo ho yɛ koraa. Kɔ do yɛ akwahoodzen nneyɛe pa.",
		"A score in the 90–100 range means all analyzed test markers are within standard optimal limits.": "Ahoɔden bɔ 90–100 kyerɛ dɛ wo nhwehwɛmu nyina yɛ papa koraa.",
		"Boost Blood Health": "Ma Mogya Ahoɔden Do",
		"Support Immunity": "Boa Banbɔ Dwumadzi",
		"Stay Hydrated": "Nom Nsuo Pii Daa",
		"Consult a Pediatrician": "Kasa Kyerɛ Datser Pa",
		"Consult a Doctor": "Kasa Kyerɛ Datser Pa",
		"Since the PCV (red blood cell volume) is slightly low, encourage the child to eat more Kontomire (cocoyam leaves) and Moringa powder. These are rich in iron which helps build healthy blood. Pair these with a little bit of orange juice to help the body absorb the iron better.": "Esiane dɛ PCV aba fam kakra ntsi, hyɛ nkuran ma wonni kontomire ne moringa powder pii. Yeinom wɔ iron pii a ɔboa ma mogya yɛ dzen. Fa ankaa nsuo kakra fra mu ma wo honam ntum nnonsu iron no yie.",
		"The WBC (white blood cell count) is a bit low, meaning the immune system needs support. Provide nutritious, easy-to-digest meals like light Koko (porridge) and plenty of fresh fruits like oranges or mangoes to provide vitamins that help the body fight germs.": "WBC aba fam kakra, a ɔkyerɛ dɛ banbɔ ho hia mmoa. Ma aduane pa a ɔyɛ mmerɛw tse dɛ koko mmerɛw ne nsuaba tse dɛ ankaa anaa mangoes na emua vitamins a ɔko yarba mmoawa.",
		"Ensure the child drinks plenty of clean, boiled water or coconut water throughout the day to keep their body systems running smoothly and help with overall recovery.": "Hwɛ dɛ wɔnom nsuo fiewedze anaa kubesuo pii da mu nyina na ama honam mu dwumadzi akɔ do yie.",
		"Because the white blood cell count and basophils are slightly out of the normal range, please take these results to your local doctor or pediatrician. They can check if this is due to a recent mild infection or an allergy.": "Esiane dɛ white blood cell count ne basophils mfa dɛ ɔtaa yɛ mu ntsi, mesrɛ wo fa saa nhwehwɛmu yi kɔ wo datser nkyɛn. Wɔbɛtum ahwɛ sɛ ebia ɔfiri yarba mmoawa kakra anaa allergy.",
		"Always speak to a qualified doctor or pediatrician about your health. Visit your nearest CHPS compound or health center for clinical evaluation.": "Kasa kyerɛ datser pa biara wɔ wo ahoodzen ho daa. Kɔ CHPS compound anaa ayaresabea a ɛbɛn wo nkyɛn."
	},
};
